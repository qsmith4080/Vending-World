...
public class ArrayDeque<T> {
    ...
    /**
     * doubles the backing array length when the backing array
     * is full
     */
    private void resize() {
        ...
        for (int i = 0; i < backingArray.length; i++) {
            temp[i + 1] = backingArray[curr];
            curr = (curr + 1) % backingArray.length;
        }
    ...
    public void addFirst(T data) {
        ...
        front = mod((backingArray.length - 1) - size, backingArray.length);
    ...
    public T removeLast() {
        ...
        T deletedData = backingArray[last];
